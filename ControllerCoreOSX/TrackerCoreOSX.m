...
NSInteger cmpEventStamp(id val1, id val2, void *context)
{
    //ignore context;
...
CFComparisonResult CmpEventStamp_CF (const void *val1, const void *val2, void *context)
{
                         ...
                         selfOfNotifyFunc:(voidPtr) aSpecialSelf
{
    ...
    notifyFuncSelf=aSpecialSelf;//TODO: TBC notifyFuncSelf implemented right?
